...
img_base_name=eta_sebal_
# original data from ETb
img_root=/media/disk2part1/RS/3_Products/eta_sebal/
# img_root=eta/
...
do
	...
	outfile=$(cat out.txt)
	echo $outdir/$subset_name\_eta_$outfile
	gdalwarp -q -te $box -cutline $full_area_name.shp $file $outdir/$subset_name\_eta_$outfile
done 
